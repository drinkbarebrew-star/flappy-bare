...
export class Renderer {
  ...
  drawBackground() {
    ...
    skyGrad.addColorStop(0,   '#0d0805')
    skyGrad.addColorStop(0.3, '#150c06')
    skyGrad.addColorStop(0.6, '#1f1209')
    skyGrad.addColorStop(0.8, '#2c1a0a')
    skyGrad.addColorStop(1,   '#3d2410')
  ...
  private drawCan(x: number, y: number, w: number, h: number, flip: boolean) {
    ...
    canGrad.addColorStop(0,    '#9a7520')
    canGrad.addColorStop(0.28, COLORS.gold)
    canGrad.addColorStop(0.5,  COLORS.canHighlight)
    canGrad.addColorStop(0.72, COLORS.gold)
    canGrad.addColorStop(1,    '#9a7520')
    ...
    ctx.fillRect(-4, h - 14, w + 8, 16)
    ctx.fillStyle = COLORS.canHighlight
    ctx.fillRect(-4, h - 14, w + 8, 3)

    // Shine stripe
    ctx.fillStyle = 'rgba(255, 255, 255, 0.08)'
    ctx.fillRect(w * 0.14, 4, w * 0.13, h - 18)
